...
@section('title', 'Edit Admin - MM Certify')
        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3 mb-0">Edit Admin: {{ $admin->name }}</h6>
                </div>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('admin.update-admin', $admin->id) }}" method="POST">
                        ...
                        <div class="col-12">
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" name="is_super_admin" id="is_super_admin" value="1" 
                                       {{ old('is_super_admin', $admin->adminPermission?->is_super_admin) ? 'checked' : '' }}>
                    ...
                    <div class="row" id="menu-permissions" style="{{ old('is_super_admin', $admin->adminPermission?->is_super_admin) ? 'display: none;' : '' }}">
                        <div class="col-12">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="menu_permissions[]" value="{{ $key }}" id="menu_{{ $key }}" 
                                               {{ in_array($key, old('menu_permissions', $admin->adminPermission?->menu_permissions ?? [])) ? 'checked' : '' }}>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <button type="submit" class="btn bg-gradient-primary">Update Admin</button>
