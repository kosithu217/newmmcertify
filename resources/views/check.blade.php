...
<body>
    ...
    <p style="text-align: center;text-align: justify;">
        MM Certify ensures the authenticity of digital certificates issued 
        by our partner academic and business institutions, providing seamless 
        verification for learners, employers and recruiters.
    </p>
   
    
  <p style="text-align: center;text-align: justify;">
        Beyond verification, MM Certify and our partners help learners to showcase their memorable course achievements, making their qualifications stand out.
    </p>
            <div class="col-md-6">
                
                <h2 class="text-center mb-5">Provide the following details</h2>
